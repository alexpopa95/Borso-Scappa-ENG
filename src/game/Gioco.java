...
public class Gioco extends Canvas implements Runnable, KeyListener {
    ...
    public final String TITOLO = "Borso escapes (ENGLISH)";
    ...
    private void disegna() {
        ...
        if(State == STATE.GAME){
            ...
            if(moneteLivello<10) {
                ...
                if(Gioco.seminato1 || Gioco.seminato2 || Gioco.seminato3) g.drawString("YOU ARE SAFE... Be careful not to fall", 160+30, 15);
            }
            else {
                g.setColor(Color.GREEN);
                g.drawString("YOU CAN CONTINUE", 160+30, 15);
            }
        }
